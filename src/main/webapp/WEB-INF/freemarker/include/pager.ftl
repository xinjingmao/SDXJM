...
<#-- 输出分页样式 -->
<style type="text/css">
.pagination {padding: 5px;float:right;font-size:12px;margin-top:20px;position:static;}
...
.pagination a:hover, .pagination a:active {border: 1px solid #f90;color: #000;text-decoration: none;}
.pagination span.current {padding: 2px 5px;margin: 2px;border: 1px solid #f90;font-weight: bold;background-color: #f90;color: #FFF;}
